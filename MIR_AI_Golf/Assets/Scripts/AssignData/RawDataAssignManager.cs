...
namespace EthanLin.AssignDataHelper
{
    ...
    {
        [SerializeField] private int _senenIndex;
        ...
        [Header("Normal 場景用的, RawData角色要站的位置")] [SerializeField] private GameObject _rawdataRoleStandingPoint;
        ...
        private void Update()
        {
            ...
            if (_dataStringToQuaternionHelper != null)
            {
                ...
                // 只有上半身
                if (_variationConfig.GetOnlyUpperBody)
                {
                    // 胸當下面向的方向
